  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4 z-10">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <GlassCard glowColor="purple" hoverEffect title="SYSTEM ACCESS" subtitle="mentor operator login">
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#050308]/60 border border-neutral-800 rounded-md py-2.5 pl-10 pr-4 text-sm text-white placeholder-neutral-600 focus:outline-none focus:border-[#8B5CF6] focus:ring-1 focus:ring-[#8B5CF6] transition-colors"
                  value={email}
              ...
              <label className="text-[10px] uppercase font-mono tracking-widest text-[#8B5CF6]">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    placeholder="••••••••"
                    className="w-full bg-[#050308]/60 border border-neutral-800 rounded-md py-2.5 pl-10 pr-10 text-sm text-white placeholder-neutral-600 focus:outline-none focus:border-[#8B5CF6] focus:ring-1 focus:ring-[#8B5CF6] transition-colors"
                    value={password}
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    className="text-[10px] font-mono text-neutral-500 hover:text-[#FF4DCA] transition-colors tracking-widest uppercase mt-1"
                  >
                    FORGOT PASSWORD?
                  </button>
                </div>
            ...
            <div className="pt-2">
              <CyberButton variant="purple" fullWidth type="submit" disabled={loading}>
          ...
          <div className="mt-6 text-center text-xs text-neutral-500 font-mono">
            New operator?{' '}
            <Link href="/signup" className="text-[#FF4DCA] hover:text-[#ff7ae0] transition-colors hover:underline">
              INITIALIZE AGENT
            </Link>
          </div>
        </GlassCard>
